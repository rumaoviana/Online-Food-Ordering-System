...
<head>
  ...
  .right-alert textarea.materialize-textarea + label:after{
      right:70px;
	   ...
	   body  {
  background-image: url("C:\xampp1\htdocs\Epic Eateries\images\pizza.jpg");
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> reviews/Complaints</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="tickets.php">All Review/Complaints</a>
                                </li>
								<?php
...
body {
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            ...
            body { 
              ...
              <label for="description" class=""><b>Any note(optional)</b></label>
			  </div>
			  <div>
			  <div class="input-field col s12">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2020 <a class="grey-text text-lighten-4" href="#" target="_blank">Viana Rumao</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Viana Rumao</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
