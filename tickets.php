      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Review/Complaints</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
								if(!isset($_GET['status'])){
									...
									"><a href="tickets.php">All Review/Complaints</a>
                                </li>
								<?php
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Review/Complaints</h5>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Write a Review/Complaint</h4>
              </div>
<div>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">List of your Review/Complaint</p>
          <div class="divider"></div>
