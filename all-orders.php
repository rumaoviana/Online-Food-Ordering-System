  ...
  <div id="main">
    ...
    <div class="wrapper">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Reviews/Complaints</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">All Review/All Review/Complaints</a>
                                </li>
								<?php
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><b>List of orders by customers with details</b></p>
          <style>
body {
...
<div id="work-collections" class="seaction">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2020 <a class="grey-text text-lighten-4" href="#" target="_blank">Vianna Rumao</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Vianna Rumao</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
