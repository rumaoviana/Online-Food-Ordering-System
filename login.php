...
<head>
  ...
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="images/favicon/materialize-logo.png">
  <!-- For iPhone -->
...
<body class="cyan" style="background-color:powderblue;">
      ...
      <form method="post" action="routers/router.php" class="login-form" id="form">
        ...
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text">Login for Manpe Eateries</p>
          </div>
        </div>
