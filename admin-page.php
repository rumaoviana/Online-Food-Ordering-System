            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">  
                      ...
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/materialize-logo.png" alt="logo"></a> <span class="logo-text">Manpe Eateries</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
                ...
                <li class="no-padding">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Reviews/Complaints</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">All Reviews/Complaints</a>
                                </li>
								<?php
        ...
        <div id="breadcrumbs-wrapper">
          <div class="container">
            ...
            body { 
                ...
                <h5 class="breadcrumbs-title">Menu Management</h5>
                <style>
body {
  ...
  background-size: cover;
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><b>Add, Edit or Remove Menu Items.</b></p>
...
<table>
                    <thead>
                      <tr>
                        <th data-field="id"><b>Name</b></th>
                        <th data-field="name"><b>Item Price/Piece</b></th>
                      </tr>
                    </thead>

                    <tbody>
				<?php
					echo '<tr><td><div class="input-field col s12"><label for="name"><b>Name</b></label>';
					echo '<input id="name" name="name" type="text" data-error=".errorTxt01"><div class="errorTxt01"></div></td>';					
					echo '<td><div class="input-field col s12 "><label for="price" class=""><b>Price</b></label>';
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2020 <a class="grey-text text-lighten-4" href="#" target="_blank">Vianna</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Vianna</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
